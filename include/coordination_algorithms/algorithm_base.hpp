...
class AlgorithmBase
{
  ...
  **/
  ...
  virtual void getAbsoluteVelocity(const sensor_msgs::JointState &state,
                                   const Vector3d &r1, const Vector3d &r2,
                                   Vector6d &abs_vel) const = 0;
  virtual void getRelativeVelocity(const sensor_msgs::JointState &state,
                                   const Vector3d &r1, const Vector3d &r2,
                                   Vector6d &rel_vel) const = 0;

  /**
    Get the absolute motion frame implicitly defined by the implemented
  ...
  **/
  virtual KDL::Frame getAbsoluteMotionFrame(const KDL::Frame &obj1,
                                            const KDL::Frame &obj2) const = 0;

  /**
    Get the relative motion frame implicitly defined by the implemented
  coordination algorithm.
  **/
  virtual KDL::Frame getRelativeMotionFrame(const KDL::Frame &obj1,
                                            const KDL::Frame &obj2) const = 0;
